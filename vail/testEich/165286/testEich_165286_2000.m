...
xlabel('R [m]')
ylabel('Z [m]')
title([int2str(165286) ': ' int2str(2000) ' ms'])
    
% Load the equilibrium

eq = read_eq(165286, 2.00, '/u/pvail/d3d_snowflake_2019/testEich/165286');
...
options.StartPoint = [40 1.4 0.2 150, 1];
...
text(100, 20, ['S = ' num2str(S,'%3.1f') ' cm'], 'FontSize', 12)

text(100, 17, ['\lambda_{q} = ' num2str(lambdaQ,'%3.1f') ' cm'], ...
    'FontSize', 12)

text(100, 14, ['f_{exp} = ' num2str(fExp,'%3.1f')], 'FontSize', 12)
