...
BrSP = interp2(rg257, zg257, Br257257, spRZLP(1,1), spRZLP(1,2));
BzSP = interp2(rg257, zg257, Bz257257, spRZLP(1,1), spRZLP(1,2));
...
options.StartPoint = [500 1.4 0.2 125 40];
options.Lower = [0 0 0 0 0];
 
fitEich = fit(s(idxInner), qperp(idxInner), ft, 'problem', fExp, options);
