...
efit_dirname = '/u/pvail/d3d_snowflake_2019/invMap/validation/155355';
...
chi = 0.02; % thermal  diffusivity [Wb^2/s]
...
optionsOuter.StartPoint = [max(qdiv_perp_SP2) 0.01 lambdaQ sSP 0];
...
qperp = transpose(importdata('qperp_155355_5100.txt'));

qperp = qperp*(100)^2*(1e-6);
 
s = importdata('s_155355_5100.txt');
