...
frad = 0.3; % radiated power fraction
    ...
    if psixSL > psixPL % SFD-Plus
        ...
        if rxPL < rxSL % LFS
            ...
            if ismember(ii, idxInner)
                ...
                rz = isoflux_cpFinder(psizr257257, psiSOLi, rg257, zg257, ...
                    [rxPL rxSL zxPL zxSL]);
...
for ii = 1:length(psiDivSP2)
    ...
    rz = isoflux_spFinder(psizr257257, psiDivSP2(ii), rg257, zg257, ...
        limdata, limIdxL);
...
if plotit
   ...
   plot(100*sDiv_SP2, qdiv_perp_SP2, '-r', 'LineWidth', 1)
...
% options.StartPoint = [1 1 0.01 5 1.10];
% options.Lower = [0 0 0 0 0];
%  
% fitEich_SP1 = fit(sDiv_SP1, qdiv_perp_SP1, ft, options);
 
% Extract the coefficients
 
% q0_SP1      = fitEich_SP1.q0;
% S_SP1       = fitEich_SP1.S;
% lambdaQ_SP1 = fitEich_SP1.lambdaQ;
% fExp_SP1    = fitEich_SP1.fExp;
% s0_SP1      = fitEich_SP1.s0;
...
%     q0       = q0_SP1;
%     S        = 100*S_SP1;
%     lambdaQ  = 100*lambdaQ_SP1;
%     fExp     = fExp_SP1;
%     s0       = 100*s0_SP1;
%     
%     qperp_Eich_SP1 = (q0/2)*exp((S/(2*lambdaQ*fExp))^2 - (s_Eich - s0)./...
%         (lambdaQ*fExp)).*erfc(S/(2*lambdaQ*fExp) - (s_Eich - s0)./S);
%     
%     figure(2)
%     plot(s_Eich, qperp_Eich_SP1, '-b', 'LineWidth', 1)
% 
% end
...
% options = fitoptions(ft);
% options.StartPoint = [0.1 1 0.01 10 1.40];
% options.Lower = [0 0 0 0 0];
%  
% fitEich_SP2 = fit(sDiv_SP2, qdiv_perp_SP2, ft, options);
 
% Extract the coefficients
 
% q0_SP2      = fitEich_SP2.q0;
% S_SP2       = fitEich_SP2.S;
% lambdaQ_SP2 = fitEich_SP2.lambdaQ;
% fExp_SP2    = fitEich_SP2.fExp;
% s0_SP2      = fitEich_SP2.s0;
...
%     q0       = q0_SP2;
%     S        = 100*S_SP2;
%     lambdaQ  = 100*lambdaQ_SP2;
%     fExp     = fExp_SP2;
%     s0       = 100*s0_SP2;
%     
%     qperp_Eich_SP2 = (q0/2)*exp((S/(2*lambdaQ*fExp))^2 - (s_Eich - s0)./...
%         (lambdaQ*fExp)).*erfc(S/(2*lambdaQ*fExp) - (s_Eich - s0)./S);
%     
%     figure(2)
%     plot(s_Eich, qperp_Eich_SP2, '-b', 'LineWidth', 1)
% 
% end
...
% options = fitoptions(ft);
% options.StartPoint = [1 1 0.01 5 1.60];
% options.Lower = [0 0 0 0 0];
%  
% fitEich_SP3 = fit(sDiv_SP3, qdiv_perp_SP3, ft, options);
 
% Extract the coefficients
 
% q0_SP3      = fitEich_SP3.q0;
% S_SP3       = fitEich_SP3.S;
% lambdaQ_SP3 = fitEich_SP3.lambdaQ;
% fExp_SP3    = fitEich_SP3.fExp;
% s0_SP3      = fitEich_SP3.s0;
...
%     q0       = q0_SP3;
%     S        = 100*S_SP3;
%     lambdaQ  = 100*lambdaQ_SP3;
%     fExp     = fExp_SP3;
%     s0       = 100*s0_SP3;
%     
%     qperp_Eich_SP3 = (q0/2)*exp((S/(2*lambdaQ*fExp))^2 - (s_Eich - s0)./...
%         (lambdaQ*fExp)).*erfc(S/(2*lambdaQ*fExp) - (s_Eich - s0)./S);
%     
%     figure(2)
%     plot(s_Eich, qperp_Eich_SP3, '-b', 'LineWidth', 1)
% 
% end
