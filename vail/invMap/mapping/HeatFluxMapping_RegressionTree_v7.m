...
% REGRESSION TREE
% Predictors: sDiv_qmax_SP1, sDiv_qmax_SP2, sDiv_qmax_SP3, FWHM_SP1, FWHM_SP2, 
%             FWHM_SP3
...
tbl_rxP = table(spData_Train(:,16), spData_Train(:,17), spData_Train(:,18), ...
                spData_Train(:,19), spData_Train(:,20), spData_Train(:,21), ...
                xpData_Train(:,1),                                          ...
                'VariableNames', {'sDiv_qmax_SP1', 'sDiv_qmax_SP2',         ...
                'sDiv_qmax_SP3', 'FWHM_SP1', 'FWHM_SP2', 'FWHM_SP3', 'rxP'});

tbl_rxS = table(spData_Train(:,16), spData_Train(:,17), spData_Train(:,18), ...
                spData_Train(:,19), spData_Train(:,20), spData_Train(:,21), ...
                xpData_Train(:,2),                                          ...
                'VariableNames', {'sDiv_qmax_SP1', 'sDiv_qmax_SP2',         ...
                'sDiv_qmax_SP3', 'FWHM_SP1', 'FWHM_SP2', 'FWHM_SP3', 'rxS'});
            
tbl_zxP = table(spData_Train(:,16), spData_Train(:,17), spData_Train(:,18), ...
                spData_Train(:,19), spData_Train(:,20), spData_Train(:,21), ...
                xpData_Train(:,3),                                          ...
                'VariableNames', {'sDiv_qmax_SP1', 'sDiv_qmax_SP2',         ...
                'sDiv_qmax_SP3', 'FWHM_SP1', 'FWHM_SP2', 'FWHM_SP3', 'zxP'});
            
tbl_zxS = table(spData_Train(:,16), spData_Train(:,17), spData_Train(:,18), ...
                spData_Train(:,19), spData_Train(:,20), spData_Train(:,21), ...
                xpData_Train(:,4),                                          ...
                'VariableNames', {'sDiv_qmax_SP1', 'sDiv_qmax_SP2',         ...
                'sDiv_qmax_SP3', 'FWHM_SP1', 'FWHM_SP2', 'FWHM_SP3', 'zxS'});
...
rxP_PRED_TRAIN = predict(rtree_rxP, spData_Train(:,16:21));
rxS_PRED_TRAIN = predict(rtree_rxS, spData_Train(:,16:21));
zxP_PRED_TRAIN = predict(rtree_zxP, spData_Train(:,16:21));
zxS_PRED_TRAIN = predict(rtree_zxS, spData_Train(:,16:21));
...
rxP_PRED_TEST = predict(rtree_rxP, spData_Test(:,16:21));
rxS_PRED_TEST = predict(rtree_rxS, spData_Test(:,16:21));
zxP_PRED_TEST = predict(rtree_zxP, spData_Test(:,16:21));
zxS_PRED_TEST = predict(rtree_zxS, spData_Test(:,16:21));
