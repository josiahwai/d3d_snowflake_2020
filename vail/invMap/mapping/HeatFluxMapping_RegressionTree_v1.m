...
tbl_rxP = table(spData_Train(:,7), spData_Train(:,8), spData_Train(:,9), ...
    xpData_Train(:,1), 'VariableNames', {'s_SP1', 's_SP2', 's_SP3', 'rxP'});

tbl_rxS = table(spData_Train(:,7), spData_Train(:,8), spData_Train(:,9), ...
    xpData_Train(:,2), 'VariableNames', {'s_SP1', 's_SP2', 's_SP3', 'rxS'});

tbl_zxP = table(spData_Train(:,7), spData_Train(:,8), spData_Train(:,9), ...
    xpData_Train(:,3), 'VariableNames', {'s_SP1', 's_SP2', 's_SP3', 'zxP'});

tbl_zxS = table(spData_Train(:,7), spData_Train(:,8), spData_Train(:,9), ...
    xpData_Train(:,4), 'VariableNames', {'s_SP1', 's_SP2', 's_SP3', 'zxS'});
...
rxP_PRED_TRAIN = predict(rtree_rxP, spData_Train(:,7:9));
rxS_PRED_TRAIN = predict(rtree_rxS, spData_Train(:,7:9));
zxP_PRED_TRAIN = predict(rtree_zxP, spData_Train(:,7:9));
zxS_PRED_TRAIN = predict(rtree_zxS, spData_Train(:,7:9));
...
rxP_PRED_TEST = predict(rtree_rxP, spData_Test(:,7:9));
rxS_PRED_TEST = predict(rtree_rxS, spData_Test(:,7:9));
zxP_PRED_TEST = predict(rtree_zxP, spData_Test(:,7:9));
zxS_PRED_TEST = predict(rtree_zxS, spData_Test(:,7:9));
