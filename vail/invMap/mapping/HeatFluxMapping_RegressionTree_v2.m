...
% REGRESSION TREE
% Predictors: s_SP1, s_SP2, s_SP3, fExp_SP1, fExp_SP2, fExp_SP3
...
rxP_PRED_TRAIN = predict(rtree_rxP, spData_Train(:,7:12));
rxS_PRED_TRAIN = predict(rtree_rxS, spData_Train(:,7:12));
zxP_PRED_TRAIN = predict(rtree_zxP, spData_Train(:,7:12));
zxS_PRED_TRAIN = predict(rtree_zxS, spData_Train(:,7:12));
...
rxP_PRED_TEST = predict(rtree_rxP, spData_Test(:,7:12));
rxS_PRED_TEST = predict(rtree_rxS, spData_Test(:,7:12));
zxP_PRED_TEST = predict(rtree_zxP, spData_Test(:,7:12));
zxS_PRED_TEST = predict(rtree_zxS, spData_Test(:,7:12));
