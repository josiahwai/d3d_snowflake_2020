...
fid = fopen('option.txt', 'r');
number = textscan(fid, '%s');
fclose(fid);
...
eq_dir  = '/u/pvail/d3d_snowflake_2019/invMap/shotdir/synthetic/';
eq_name = ['eq_' number '.mat'];
...
if saveit
    save(['HeatFluxSimulation_' number '.mat'], 'HeatFluxSimulation')
end
