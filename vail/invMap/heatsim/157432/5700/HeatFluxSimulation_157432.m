...
[rxPL, zxPL, psixPL] = isoflux_xpFinder(psizr, 1.12, -1.21, rg, zg);
[rxSL, zxSL, psixSL] = isoflux_xpFinder(psizr, 1.16, -1.26, rg, zg);
...
psiDivSP2 = linspace(minpsi2 - 0.003, maxpsi2 + 0.005, 100);
