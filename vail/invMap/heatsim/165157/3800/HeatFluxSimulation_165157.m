...
[rxPL, zxPL, psixPL] = isoflux_xpFinder(psizr, 1.18, -1.31, rg, zg);
[rxSL, zxSL, psixSL] = isoflux_xpFinder(psizr, 1.11, -1.29, rg, zg);
...
psiDivSP2 = linspace(minpsi2 - 5e-4, maxpsi2 + 0.002, 100);
