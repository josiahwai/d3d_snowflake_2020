...
psiDivSP2 = linspace(minpsi2 - 0.005, maxpsi2 + 0.002, 100);
...
for ii = 1:length(psiDivSP2)
    ...
    switch size(rz,1)
        case 2
            rzDiv_SP2(ii,1) = rz(1,1);
            rzDiv_SP2(ii,2) = rz(1,2);
        case 4
            if rxPL < rxSL % LFS
...
rzDiv_SP2(85,1) = rzDiv_SP2(84,1);
rzDiv_SP2(85,2) = rzDiv_SP2(84,2);
...
if psixSL > psixPL % SFD-Plus
    ...
    if rxPL < rxSL % LFS
        ...
        idxpsi = setdiff(idxOuter,find(isnan(zentr(:,2))));
...
psiDivSP3 = linspace(minpsi3, maxpsi3 + 0.004, 100);
...
rzDiv_SP3(82,1) = rzDiv_SP3(81,1);
rzDiv_SP3(82,2) = rzDiv_SP3(81,2);
