function [rmaxis, zmaxis, psimaxis] = isoflux_maxisFinder(psizr, ...
    rmaxis0, zmaxis0, rg, zg)
%
% ISOFLUX_MAXISFINDER
%
%   Given the magnetic flux from a plasma equilibrium, determine the (r,z)
%   coordinates of the magnetic axis given an initial guess for the maxis 
%   position (rmaxis0, zmaxis0).
%
% USAGE: isoflux_maxisFinder.m
%
% INPUTS:
%
%   psizr.......matrix with dimensions (nz x nr) containing the magnetic
%               flux at nz vertical by nr radial grid points
%
%   rmaxis0.....initial guess for the maxis radial coordinate
%
%   zmaxis0.....initial guess for the maxis vertical coordinate
%
...
% OUTPUTS: 
%
%   rmaxis......radial position of the magnetic axis
%
%   zmaxis......vertical position of the magnetic axis
%
%   psimaxis....magnetic flux on axis
%
% METHOD: This script uses Newton's method to locate the axis (Br = Bz = 0)
...
%   Patrick J. Vail: Original File 05/25/2017
%
%...............................................................................
...
while ii > 0 && brzmax > 1e-10
    ...
    ir = find(rg < rmaxis, 1, 'last');
    iz = find(zg < zmaxis, 1, 'last');
    ...
    psimaxis = [1 tz tz^2 tz^3]*mx*[b0 b1 b2 b3]';
    ...
    rmaxis = rmaxis + delta(1);
    zmaxis = zmaxis + delta(2);
