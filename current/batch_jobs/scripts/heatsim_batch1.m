% BATCH JOB SUBMISSION VERSION OF heatsim.m
...
saveit = 1;
cake_constrained = 1;
cake_unconstrained = ~cake_constrained;

% cake_constrained
if cake_constrained
    saveDir = [root 'outputs/hfsims/cake_constrained/' num2str(shot) '/'];
    eqdir = [root 'outputs/eqs/' num2str(shot) '/'];
    eqdata = ['eq_c_' num2str(shot) '_' num2str(time_ms) '.mat'];
    load([eqdir eqdata])
end

% cake unconstrained
if cake_unconstrained
    saveDir = [root 'outputs/hfsims/cake_unconstrained/' num2str(shot) '/'];   
