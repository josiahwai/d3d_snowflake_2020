...
% rsplit_mid = rmid - lambda_q * log(qirmax(3)/sum(qirmax(2:3)));
% psixS1 = bicubicHermite(rg,zg,psizr,rsplit_mid,zmid);
% fexp = 5-15 in snowflake region

drsplit_mid = -lambda_q * log(qirmax(3)/qmax(3) * sum(qmax(2:3))/sum(qirmax(2:3)));

[~,dpsidr] = bicubicHermite(rg,zg,psizr,rmid,zmid);
dpsi = dpsidr * drsplit_mid;
psixS1 = psixS0 + dpsi;
...
% need to move to higher or lower psi to mach heat flux split
...
% Correction due to SP3 mismatch
% ...............................
