function xp1 = estimate_xpts_sfp(eq0, ef, plotit)
...
if norm(errorP) > 5*norm(errorS), correct_secondary_mismatch = 0; end  
...
if correct_secondary_mismatch  
  ...
  dxpS = c_relax * wtS * (0.5*resS + 0.5*resS'*resS / (what'*resS) * what);
