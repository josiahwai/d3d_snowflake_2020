...
eqdir = '/u/pvail/d3d_snowflake_2019/HeatFluxConstrainedEQ/165288/4000/EFIT01/';
eqnam = 'eq_165288_4000_EFIT01.mat';
...
frad_SP1 = 0.90; % radiated power fraction for SP1
...
frad_SP2 = 0.90; % radiated power fraction for SP2
...
if saveit
    save(['HeatFluxSimulation_' int2str(shot) '_' int2str(time) ...
        '_EFIT01.mat'], 'HeatFluxSimulation')
end
